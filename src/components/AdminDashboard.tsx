...
import { 
  ...
  Menu, X, Sparkles, LayoutDashboard, Calendar, UserCheck, Settings, FileText, Receipt, GraduationCap, Briefcase, Feather, ScrollText
} from 'lucide-react';
...
import IndigenousDeclarationTab from './IndigenousDeclarationTab';
...
import OficiosTab from './OficiosTab';
...
export default function AdminDashboard({
  ...
  const menuItems = isCollaboratorSession
    ...
    : [
        ...
        { id: 'indigenous_declaration', label: 'Declaração Indígena', icon: Feather },
        { id: 'oficios', label: 'Gerar Ofícios', icon: ScrollText },
