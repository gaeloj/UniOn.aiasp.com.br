...
create table if not exists configs (
  ...
  useEffect(() => {
    if (entityConfig) {
      ...
      setPresidentName(entityConfig.presidentName || '');
      setPresidentCpf(entityConfig.presidentCpf || '');
    }
  }, [entityConfig]);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-[#111111] p-6 rounded-2xl border border-white/5 shadow-xl space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="p-3.5 bg-gradient-to-r from-amber-500/10 via-neutral-900 to-transparent border border-amber-500/20 rounded-xl space-y-3">
              <div className="flex items-center justify-between">
                <label className="text-xs font-bold text-amber-300 uppercase tracking-wider flex items-center gap-1.5">
                  <Lock className="h-3.5 w-3.5 text-amber-400" />
                  Presidente / Representante Legal da Entidade
                </label>
                <span className="text-[10px] text-gray-400">Assinaturas Oficiais em Fichas e Documentos</span>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1">
                  <label className="text-[10px] text-gray-400 font-bold uppercase tracking-wider block">
                  ...
                  <input
                    ...
                    placeholder="Ex: Mário Silva dos Santos"
                    className="w-full bg-[#161616] border border-white/10 rounded-xl px-3 py-2 text-sm text-white focus:outline-none focus:border-amber-500/50 transition-colors"
                  />
                </div>
                <div className="space-y-1">
                  <label className="text-[10px] text-gray-400 font-bold uppercase tracking-wider block">
                  ...
                  <input
                    ...
                    className="w-full bg-[#161616] border border-white/10 rounded-xl px-3 py-2 text-sm text-white font-mono focus:outline-none focus:border-amber-500/50 transition-colors"
                  />
                </div>
              </div>
              <p className="text-[10px] text-gray-400 leading-relaxed">
                Este nome e CPF são inseridos automaticamente em todas as assinaturas de <strong>Representante Legal</strong> nas fichas cadastrais, termos de adesão e declarações geradas pelo sistema.
              </p>
            </div>
